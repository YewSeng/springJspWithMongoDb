...
public class SuperAdminControllerTest {
    ...
    public void testGoToCreateAdminPage() {
        ...
        ModelAndView mav = superAdminController.goToCreateAdminPage(request, response);
    ...
    public void testCreateAdminSuccess() throws Exception {
        ...
        // Invoke the controller method
        ModelAndView mav = superAdminController.createAdmin(name, username, password, request, response, redirectAttributes);

        // Verify behavior
        verify(adminService, times(1)).createAdmin(any(Admin.class));
        assertEquals("redirect:/api/v1/superadmins/getAllAdmins?page=0&size=5", mav.getViewName());
    ...
    public void testCreateAdminUsernameAlreadyExists() throws Exception {
        ...
        // Invoke the controller method
        SuperAdminController superAdminController = new SuperAdminController(adminService, jwtValidator);
        ModelAndView mav = superAdminController.createAdmin(name, username, password, request, response, redirectAttributes);

        // Verify behavior
        verify(adminService, never()).createAdmin(any(Admin.class)); // Ensure createAdmin is not called
        assertEquals("redirect:/api/v1/superadmins/createAdmin", mav.getViewName());
    ...
    public void testGetAllAdmins() {
        ...
        ModelAndView mav = superAdminController.getAllAdmins(0, 10, request, response);
    ...
    public void testFilterAdmins() {
        ...
        // Call the controller method
        ModelAndView mav = superAdminController.filterAdmins("name", "John", 0, 10, request, response);
    ...
    public void testFilterAdminsUsernameSearch() {
        ...
        ModelAndView mav = superAdminController.filterAdmins("username", "john", 0, 10, request, response);
    ...
    public void testFilterAdminsNoSearchTerm() {
        ...
        ModelAndView mav = superAdminController.filterAdmins("name", "", 0, 10, request, response);

        // Verify behavior when no search term is provided
        assertEquals("redirect:/api/v1/superadmins/getAllAdmins", mav.getViewName());
    }
    ...
    public void testFilterAdminsDefaultSearch() {
        ...
        ModelAndView mav = superAdminController.filterAdmins("other", "term", 0, 10, request, response);
    ...
    public void testGoToUpdateAdminPageAdminFound() {
        ...
        // Call the controller method
        ModelAndView mav = superAdminController.goToUpdateAdminPage(admin.getAdminId(), request, response);
    ...
    public void testGoToUpdateAdminPageAdminNotFound() {
        ...
        // Call the controller method
        ModelAndView mav = superAdminController.goToUpdateAdminPage(ObjectId.get(), request, response);
    ...
    public void testUpdateAdminSuccess() throws AdminNotFoundException, UsernameAlreadyExistException {
        ...
        // Call the controller method
        ModelAndView mav = superAdminController.updateAdmin(adminId, name, username, password, request, response, redirectAttributes);
    ...
    public void testDeleteAdminSuccess() throws Exception {
        ...
        when(request.getHeader("referer")).thenReturn("/api/v1/superadmins/getAllAdmins?page=1&size=5");

        // Call the controller method
        ModelAndView mav = superAdminController.deleteAdmin(adminId, request, response, redirectAttributes);

        // Verify behavior
        assertEquals("redirect:/api/v1/superadmins/getAllAdmins?page=1&size=5", mav.getViewName());
