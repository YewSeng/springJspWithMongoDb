function validateForm() {
    ...
    var usernameRegex = /^U[a-zA-Z0-9]{7,}$/; // Username must start with 'U' followed by at least 7 characters and numbers
    ...
    if (!usernameRegex.test(username)) {
        usernameError = "Username must start with an uppercase 'U' followed by at least 7 characters";
