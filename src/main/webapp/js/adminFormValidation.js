function validateForm() {
    ...
    var usernameRegex = /^A[a-zA-Z0-9]{7,}$/; // Username must start with 'A' followed by at least 7 characters and numbers
    ...
    if (!usernameRegex.test(username)) {
        usernameError = "Username must start with an uppercase 'A' followed by at least 7 characters";
